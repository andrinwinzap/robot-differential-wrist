...
#define AS5600_A_ENABLE_NVS false
#define INVERT_AS5600_A true

#define TB6612_A_DIR GPIO_NUM_14
#define TB6612_A_PWM GPIO_NUM_12
#define TB6612_A_INVERT_DIR false
...
#define ENDSTOP_B_POSITION ((35.0f / 180.0f) * M_PI) + (M_PI / 2)

#define AS5600_B_I2C_PORT I2C_NUM_1
#define AS5600_B_I2C_SDA 9
#define AS5600_B_I2C_SCL 10
#define AS5600_B_VELOCITY_FILTER_ALPHA 0.1f
#define AS5600_B_SCALE_FACTOR 1.0f
#define AS5600_B_ENABLE_NVS false
#define INVERT_AS5600_B true

#define TB6612_B_DIR GPIO_NUM_6
#define TB6612_B_PWM GPIO_NUM_4
#define TB6612_B_INVERT_DIR true
